...
Last updated: 2026-04-22 (run 94)
...
| 36 | Bandwidth arithmetic invariants | quiche/src/recovery/bandwidth.rs | 5 | DONE run 90 — 22 thms + 9 examples, 0 sorry; Route-B tests 25/25 PASS (run 94) |
...
| 42 | Frame ack_eliciting/probing | quiche/src/frame.rs | 2 | NEW run94 — informal spec written; all decide; ~30 lines; HIGH |
...
| T36 (Bandwidth) | tests/bandwidth_arithmetic/ | 94 | 25 | 25/25 PASS |
...
- PR #77 (run92): REPORT.md + paper.tex — MERGED into master this run
- PR run94 (branch lean-squad-run94-24793196059-frame-spec-bandwidth-tests):
  Task 2 — T42 informal spec (frame_classification_informal.md)
  Task 8 — Route-B tests for T36 (25/25 PASS)
...
1. T42: write FVSquad/FrameClassification.lean (all decide, ~30 lines) — informal spec done
...
7. T29: extend PacketHeader.lean with full byte-list model → closes 1 sorry
8. Route-B: add more targets (e.g., RangeSet, OctetsRoundtrip)
