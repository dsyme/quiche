...
| 6 | Congestion window | `quiche/src/recovery/congestion/` | 1 — Research | ⬜ Identified | CUBIC/NewReno window arithmetic; see CRITIQUE.md |
...
1. **Congestion window** (Target 6) — write informal spec for CUBIC/NewReno window
   arithmetic; key properties: window grows on ACK, halves on loss, ≥ min_cwnd
