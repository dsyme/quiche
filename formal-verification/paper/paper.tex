...
All proofs carry zero \texttt{sorry} obligations and are verified
continuously by CI.
...
\begin{itemize}
  ...
  \item \textbf{504 Lean~4 theorems} across 23 algorithmic components,
    covering QUIC's byte framing, congestion control, flow control,
...
and \textbf{0 \texttt{sorry}}, verified by Lean~4.29.0 via the Lake build
system.
...
\midrule
\multicolumn{3}{l}{\textbf{Total}}                                               & \textbf{504} & \textbf{0 sorry} & \\
\bottomrule
\end{tabular}
...
The project has accumulated 504 machine-checked theorems with zero
\texttt{sorry} obligations, covering byte framing, congestion control,
flow control, packet-number arithmetic, and stream management.
