...
\textbf{533 named theorems across 25 files}, covering core QUIC algorithms
from byte-level framing through congestion control and stream management.
530 of these theorems are fully sorry-free; 3~\texttt{sorry} obligations
...
\begin{itemize}
  ...
  \item \textbf{533 Lean~4 theorems} (530 sorry-free) across 25 algorithmic
...
Table~\ref{tab:targets-overview} shows the 35 identified targets and their
current phases; 25 have reached Phase~5 (proofs complete or in progress).
...
\midrule
5 — Proofs complete      & 25 & 25 \\
4 — Implementation       &  1 & (T29, PacketHeader) \\
2 — Informal spec        &  2 & (T31, T33) \\
0/1 — Identified/Researched & 7 & — \\
\midrule
\textbf{Total identified} & \textbf{35} & \textbf{25} \\
\bottomrule
\end{tabular}
\caption{Pipeline phase distribution across 35 identified FV targets.}
...
Table~\ref{tab:theorems} summarises the 25 Lean files.
The project totals \textbf{533 named theorems}, \textbf{198 examples},
...
\midrule
\multicolumn{3}{l}{\textbf{Total}}                                               & \textbf{533} & \textbf{3 sorry}$^{\dagger}$ & \\
\bottomrule
\end{tabular}
\caption{Summary of 25 Lean~4 files: Rust source, logical layer, named
...
The 25 files form four logical layers, as shown in
Figure~\ref{fig:arch}.
...
This is itself a positive finding: the 533 theorems provide formal
...
We have presented an incremental formal verification of 25 algorithmic
components in \texttt{quiche}, Cloudflare's production QUIC implementation,
using Lean~4 without Mathlib.
The project has accumulated 533 machine-checked theorems; 530 are fully
...
packet-number arithmetic, stream management, and packet-header encoding.
...
exploring QPACK static table lookup correctness (T34); and exploring Aeneas
extraction to mechanically bridge the Lean model to the Rust source.
